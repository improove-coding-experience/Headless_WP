        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-400">
              Your trusted partner in finding the perfect property. Explore thousands of listings and find your dream home today.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link to="/" className="text-sm text-gray-400 link-underline">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/properties" className="text-sm text-gray-400 link-underline">
                  Properties
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm text-gray-400 link-underline">
                  Contact
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a href="tel:+919582211638" className="text-sm text-gray-400 hover:text-white transition-colors">
                  +91 9582211638
                </a>
              </li>
              <li>
                <a href="mailto:manikmahajan43@gmail.com" className="text-sm text-gray-400 hover:text-white transition-colors">
                  manikmahajan43@gmail.com
                </a>
              </li>
              <li>
                <address className="text-sm text-gray-400 not-italic">
                  Building No. 61, Sector 116, Mohali
                </address>
              </li>
            </ul>
          </div>
            ...
            <div className="flex gap-6">
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
